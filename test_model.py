...
def test_new_source():
    ...
    test_model = Model()
    test_model_2 = Model()
    test_source = LightSource("standard", 0, 0, 0.001, 4, test_model_2)
...
def test_new_ray():
    ...
    test_model = Model()
    test_model_2 = Model()
    test_ray = LightRay(2, 0.001, 4, test_model_2)
...
def test_new_ray_list():
    ...
    test_model = Model()
    test_model_2 = Model()
    test_ray_1 = LightRay(2, 0.001, 4, test_model_2)
    test_ray_2 = LightRay(4, 0.001, 4, test_model_2)
...
def test_LightSource_lengths():
    ...
    """
    test_model = Model()
    test_source = LightSource("standard", 1, 1, 0.001, 360, test_model)
    assert len(test_model._ray_list) == 1
    test_model = Model()
    test_source = LightSource("standard", 1, 1, 0.001, 180, test_model)
    assert len(test_model._ray_list) == 2
    test_model = Model()
    test_source = LightSource("standard", 1, 1, 0.001, 1, test_model)
    assert len(test_model._ray_list) == 360
    test_model = Model()
    test_source = LightSource("standard", 1, 1, 0.001, 4, test_model)
